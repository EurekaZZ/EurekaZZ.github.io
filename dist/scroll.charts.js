...
$(document).ready(function () {
    ...
    var fixedHeight = extradeathtextHeight + extradeath1Height*1.1;
...
$(document).ready(function () {
    var hospital4191Width = $("#hospital4191").width();
    var hospital4191Height = $("#hospital4191").height();
    var hospital419textHeight = $("#hospital419-text").height();
    var fixedHeight = hospital419textHeight + hospital4191Height*1.1;

    /*$(".hospital425").css("padding-top", hospital4251Height);*/
    $("#extra-death-imgs").css("width", hospital4191Width);

    var controller = new ScrollMagic.Controller();
    new ScrollMagic.Scene({
        triggerElement: "#hospital419-start",
        triggerHook: 0,
        duration: fixedHeight
    })
        .setPin("#hospital419-imgs")
        .addTo(controller);
